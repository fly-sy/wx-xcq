...
Page({
  data: {
    ...
    fortuneArr: [{
        title: '旺旺旺',
        desc: '过去就过去了,俗话说的好,风水轮流转,2019年你将,一路旺到底。'
      },
      {
        title: '财运亨通',
        desc: '在今年你的财运指数up up up，恭喜你离土豪越来越接近了！'
      },
      {
        title: '颜值爆表',
      ...
      {
        title: '升职加薪',
        desc: '今年你必定能运势旺，升职加薪出任CEO,迎娶白富美或嫁给高富帅。'
      },
      {
        title: '瘦瘦瘦',
        desc: '今年的你将会瘦瘦瘦，瘦成一道闪电，亮瞎众人的双眼。'
      },
      {
        title: '年轻十岁',
        desc: '今年的你面色红润，青春焕彩，活力四射，年轻十岁不是梦。'
      },
      {
        title: '梦想成真',
      ...
      {
        title: '赚一个亿',
        desc: '恭喜你，你的目标马上就能实现了，说不定你就是中国下一个王健林。'
      },
      {
        title: '不要装B',
        desc: '不要装AC,小心被雷劈。新的一年做人要真诚，做事要谨慎，这样就逢凶化吉啦！'
      },
      {
        title: '逢凶化吉',
      ...
      {
        title: '贵人相助',
        desc: '今年将会遇到一些不如意的事，所幸巧遇贵人，鼎力相助，走出困惑。'
      },
      {
        title: '财气冲天',
        desc: '2019发发发，赚它何止一个亿，从此过上土豪生活。'
      },
      {
        title: '步步高升',
        desc: '不管是学习还是工作，成绩和职位都大幅度提升，前途一片美好。'
      },
      {
        title: '创造奇迹',
        desc: '不要以为几率小就不可能发生，今年的你就能打破不可能，创造奇迹。'
      },
      {
        title: '666',
        desc: '今年的你不管是玩游戏还是做什么方面，都会得到众人的夸赞，忍不住举起大拇指：666'
      },
      {
        title: '扎心了',
        desc: '今年跟老铁们在一起请注意了，某些话某些动作总会扎你心。'
      },
      {
        title: '也是醉了',
        desc: '也许你对过去充满无奈、郁闷，新的一年收拾心情、重新出发，遇见更好的寄几！'
      },
      {
        title: '有钱任性',
        desc: '没错！有钱就可以任性，你就是这样的人，2019年将开始逆袭人生。'
      },
      {
        title: '靠脸吃饭',
      ...
      {
        title: '存款翻倍',
        desc: '钱包涨起来，存款涨起来。新一年你将越来越会做理财，存款正在成倍的往上升！'
      },
      {
        title: '扎心了',
        desc: '过去一年可能遇到了很多不顺新的事情，很扎心！莫担心，今年一切都会好起来。'
      },
      {
        title: '皮皮虾走',
        desc: '皮皮虾将带你走向人生巅峰，新的一年你将事事顺心。'
      },
      {
        title: '没毛病',
        desc: '今年运势没毛病，恭喜你将平步青云，涨薪啥的木有问题啦！'
      },
      {
        title: '猥琐发育',
        desc: '猥琐发育别浪~新的一年会沉稳一些，无论事业还是爱情都会有好的收获！'
      },
      {
        title: '大吉大利',
      ...
      {
        title: '百毒不侵',
        desc: '新的一年你将无所畏惧，无论遇到什么事情都无法伤害你！'
      },
      {
        title: '处变不惊',
        desc: '你拥有临危不惧的处事能力，这个能力非常重要，相信会对你未来带来大的变化！'
      },
      {
        title: '站起来撸',
        desc: '新年新气象，新的一年站起来干，你将会有不错的成果。'
      },
      {
        title: '撸起袖子',
  ...
  getUserFortune: function() {
    if (this.data.userInputName) {
      ...
      if (currentFortuneData && currentFortuneData.name) {
        ...
        let obj = {
          'title': this.data.fortuneArr[ranNumber].title,
          'desc': this.data.fortuneArr[ranNumber].desc,
